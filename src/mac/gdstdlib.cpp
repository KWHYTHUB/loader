...
namespace gd {
	namespace {
		static inline auto emptyInternalString() {
			return reinterpret_cast<_internal_string*>(*reinterpret_cast<uintptr_t*>(sapphire::base::get() + 0x6030d0) + sizeof(_internal_string));
		}
	}
	...
	string& string::operator=(char const* ok) {
		auto ret = reinterpret_cast<string*(*)(string*, char const*, size_t)>(sapphire::base::get() + 0x489f96)(this, ok, strlen(ok));
		return *ret;
	}
	string& string::operator=(string const& ok) {
		auto ret = reinterpret_cast<string*(*)(string*, string const&)>(sapphire::base::get() + 0x489f9c)(this, ok);
		return *ret;
	}
	string::~string() {
		...
		if (m_data[-1].m_refcount-- <= 0) {
			void* al;
			reinterpret_cast<void(*)(_internal_string*, void*)>(sapphire::base::get() + 0x489f78)(&m_data[-1], al);
		}
	}
